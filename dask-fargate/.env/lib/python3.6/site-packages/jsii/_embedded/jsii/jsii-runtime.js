...
if (!global[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function() {
      ...
      __webpack_require__(7).equal(global[gracefulQueue].length, 0)
    })
  }
}
...
const mkdirs = u(__webpack_require__(56))
...
const SD = __webpack_require__(87).StringDecoder
...
const types = __webpack_require__(17)
const pathModule = __webpack_require__(0).posix
const large = __webpack_require__(90)
...
const Entry = __webpack_require__(16)
...
const MiniPass = __webpack_require__(9)
const zlib = __webpack_require__(36)
const ReadEntry = __webpack_require__(16)
...
module.exports = {
  copySync: __webpack_require__(55)
}
...
const Buffer = __webpack_require__(88).Buffer
const realZlib = __webpack_require__(37)

const constants = exports.constants = __webpack_require__(89)
const Minipass = __webpack_require__(9)
...
const modeFix = __webpack_require__(91)
...
const fsm = __webpack_require__(12)
const path = __webpack_require__(0)
const mkdir = __webpack_require__(94)
const mkdirSync = mkdir.sync
const wc = __webpack_require__(39)
const pathReservations = __webpack_require__(97)
...
const getFlag = __webpack_require__(99)
...
Object.defineProperty(exports, "__esModule", { value: true });
const spec = __webpack_require__(20);
const api = __webpack_require__(13);
const serialization_1 = __webpack_require__(43);
/**
...
exports.SERIALIZERS = {
    ...
    ["Map" /* Map */]: {
        serialize(value, optionalValue, host) {
            ...
            return { [api_1.TOKEN_MAP]: mapValues(value, v => host.recurse(v, { type: mapType.collection.elementtype })) };
        },
        deserialize(value, optionalValue, host) {
            if (nullAndOk(value, optionalValue)) {
                return undefined;
    ...
    ["RefType" /* ReferenceType */]: {
        serialize(value, optionalValue, host) {
            ...
            const interfaces = spec.isInterfaceType(expectedType)
                ? [expectedType.fqn]
                : undefined;
            const jsiiType = objects_1.jsiiTypeFqn(value) || (spec.isClassType(expectedType) ? expectedType.fqn : 'Object');
...
Object.defineProperty(exports, "__esModule", { value: true });
const packageInfo = __webpack_require__(45);
const host_1 = __webpack_require__(46);
...
module.exports = JSON.parse("{\"name\":\"jsii-runtime\",\"version\":\"0.20.8\",\"description\":\"jsii runtime kernel process\",\"license\":\"Apache-2.0\",\"author\":{\"name\":\"Amazon Web Services\",\"url\":\"https://aws.amazon.com\"},\"homepage\":\"https://github.com/aws/jsii\",\"bugs\":{\"url\":\"https://github.com/aws/jsii/issues\"},\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/aws/jsii.git\",\"directory\":\"packages/jsii-runtime\"},\"engines\":{\"node\":\">= 10.3.0\"},\"main\":\"lib/index.js\",\"types\":\"lib/index.d.ts\",\"bin\":{\"jsii-runtime\":\"bin/jsii-runtime\"},\"scripts\":{\"build\":\"tsc --build && chmod +x bin/jsii-runtime && /bin/bash ./bundle.sh && npm run lint\",\"watch\":\"tsc --build -w\",\"lint\":\"eslint . --ext .js,.ts --ignore-path=.gitignore\",\"test\":\"jest\",\"test:update\":\"jest -u\",\"package\":\"package-js\"},\"dependencies\":{\"jsii-kernel\":\"^0.20.8\",\"jsii-spec\":\"^0.20.8\"},\"devDependencies\":{\"@scope/jsii-calc-base\":\"^0.20.8\",\"@scope/jsii-calc-lib\":\"^0.20.8\",\"@types/jest\":\"^24.0.23\",\"@typescript-eslint/eslint-plugin\":\"^2.6.1\",\"@typescript-eslint/parser\":\"^2.6.1\",\"eslint\":\"^6.6.0\",\"jest\":\"^24.9.0\",\"jsii-build-tools\":\"^0.20.8\",\"jsii-calc\":\"^0.20.8\",\"source-map\":\"^0.7.3\",\"source-map-loader\":\"^0.2.4\",\"typescript\":\"~3.6.4\",\"wasm-loader\":\"^1.3.0\",\"webpack\":\"^4.41.2\",\"webpack-cli\":\"^3.3.10\"},\"jest\":{\"collectCoverage\":true,\"collectCoverageFrom\":[\"**/bin/**/*.js\",\"**/lib/**/*.js\"],\"coverageReporters\":[\"lcov\",\"text\"],\"coverageThreshold\":{\"global\":{\"branches\":45,\"statements\":57}},\"errorOnDeprecated\":true,\"setupFilesAfterEnv\":[\"jest-expect-message\"],\"testEnvironment\":\"node\",\"testMatch\":[\"**/?(*.)+(spec|test).js\"]}}");
...
Object.defineProperty(exports, "__esModule", { value: true });
const jsii_kernel_1 = __webpack_require__(28);
const events_1 = __webpack_require__(10);
class KernelHost {
    constructor(inout, opts = {}) {
        this.inout = inout;
        this.opts = opts;
        this.kernel = new jsii_kernel_1.Kernel(this.callbackHandler.bind(this));
...
const os = __webpack_require__(34);
const path = __webpack_require__(0);
const tar = __webpack_require__(84);
const vm = __webpack_require__(100);
const api = __webpack_require__(13);
const api_1 = __webpack_require__(13);
const objects_1 = __webpack_require__(42);
const wire = __webpack_require__(43);
class Kernel {
    /**
...
const utimesSync = __webpack_require__(33).utimesMillisSync
...
function copyFileFallback (srcStat, src, dest, opts) {
  ...
  const _buff = __webpack_require__(58)(BUF_LENGTH)
...
const fs = __webpack_require__(1)
const path = __webpack_require__(0)
const invalidWin32Path = __webpack_require__(32).invalidWin32Path
...
const utimes = __webpack_require__(33).utimesMillis
const stat = __webpack_require__(14)
...
const fs = __webpack_require__(1)
const path = __webpack_require__(0)
const copySync = __webpack_require__(31).copySync
...
const fs = __webpack_require__(1)
const path = __webpack_require__(0)
const copy = __webpack_require__(35).copy
...
Object.defineProperty(exports, "__esModule", { value: true });
const jsonschema = __webpack_require__(80);
...
const realZlibConstants = __webpack_require__(37).constants ||
...
const mkdirp = __webpack_require__(95)
const fs = __webpack_require__(2)
const path = __webpack_require__(0)
const chownr = __webpack_require__(96)
